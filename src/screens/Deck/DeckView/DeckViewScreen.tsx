        ...
        deck: {
            ...
            cards: [{
                ...
                sides: [
                    ...
                    {
                        content: [
                            {id: "1-2-1", type: "Text", value: "Side One"},
                            {id: "1-2-2", type: "Image", value: "https://www.google.com/images/branding/googlelogo/2x/googlelogo_color_92x30dp.png"},
                            {id: "1-2-3", type: "Link", value: "https://www.google.com"},
                            {id: "1-2-4", type: "Text", value: repeat(3, i => `Line ${i+1}`).join('\n')},
                        ]
                    },
                    {
                        content: [
                            {id: "1-3-1", type: "Text", value: "Side Two"},
                            {id: "1-3-2", type: "Image", value: "https://via.placeholder.com/100x30/09f.png/fff"},
                            {id: "1-3-3", type: "Image", value: "https://via.placeholder.com/100x30/0f9.png/fff"},
                            {id: "1-3-4", type: "Image", value: "https://via.placeholder.com/100x30/90f.png/fff"},
                            {id: "1-3-5", type: "Image", value: "https://via.placeholder.com/100x30/9f0.png/fff"},
                            {id: "1-3-6", type: "Image", value: "https://via.placeholder.com/100x30/f09.png/fff"},
                            {id: "1-3-7", type: "Image", value: "https://via.placeholder.com/100x30/f90.png/fff"},
                        ]
                    },
